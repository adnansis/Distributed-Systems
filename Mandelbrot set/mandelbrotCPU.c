// Prevajanje programa: 
//				gcc mandelbrotCPU.c -O2 -lm -fopenmp -Wl,-rpath,./ -L./ -l:"libfreeimage.so.3" -o mandelbrotCPU
// Zagon programa: 
//				srun -n1 --reservation=fri mandelbrotCPU
...
int main(void) {
	...
	FreeImage_Save(FIF_PNG, dst, "mandelbrotCPU.png", 0);
